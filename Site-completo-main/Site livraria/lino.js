...
// cria lista de livros a partir do HTML
const livros = Array.from(cards).map(card => {
  return {
    nome: card.querySelector(".titulo-card")?.innerText.trim(),
...
campo.addEventListener("input", () => {
  ...
  livros
    .filter(l => l.nome.toLowerCase().includes(texto))
    .forEach(livro => {
